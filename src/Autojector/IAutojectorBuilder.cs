...
namespace Autojector
{
    ...
    public interface IAutojectorBuilder
    {
        ...
        /// </returns>
        IAutojectorBuilder UseSimpleInjectionByInterface(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseSimpleInjectionByAttribute(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseFactories(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseAsyncFactories(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseDecoratorByInterface(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseDecoratorByAttribute(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseConfigsByInteface(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseConfigsByAttribute(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseUnimplementedConfigsByInteface(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseUnimplementedConfigsByAttribute(params Assembly[] assemblies);
        ...
        /// Any method from AutojectorBuilder will return the AutojectorBuilder so it can be further called.
        /// </returns>
        IAutojectorBuilder UseChains(params Assembly[] assemblies);
    }
