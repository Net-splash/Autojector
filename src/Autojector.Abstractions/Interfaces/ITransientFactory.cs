namespace Autojector.Abstractions
{
    ...
    /// In order to be picked up by the Autojector please make sure that the Factories was added as a feature in the configureOption
    ...
    /// </typeparam>
    public interface ITransientFactory<T> : IFactory<T>
    {
    }
}