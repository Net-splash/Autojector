namespace Autojector.Abstractions
{
    ...
    /// This will provide a IAsyncDependency\f[T\f] which provide Value/ServiceAsync as a Task to retive the service
    /// </summary>
    /// <typeparam name="T">
    ...
    /// </typeparam>
    public interface IAsyncScopeFactory<T> : IAsyncFactory<T> { }
}